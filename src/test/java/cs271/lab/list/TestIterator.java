 ...
 private LinkedList<Integer> list;
  ...
  public void testRemove() {
    ...
    while (i.hasNext())
    {
      if (i.next()== 77)
      {
        i.remove(); // TODO what happens if you use list.remove(Integer.valueOf(77))?-did
       // list.remove(Integer.valueOf(77));
      }
    }
    // TODO using assertEquals and Arrays.asList, express which values are left in the list-did
  ...
  public void testAverageValues() {
    ...
    double sum = 0;
    int n = 0;
    // TODO use an iterator and a while loop to compute the average (mean) of the values-did
